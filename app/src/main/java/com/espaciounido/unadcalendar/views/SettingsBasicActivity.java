...
import com.espaciounido.unadcalendar.services.ManagerService;
...
public class SettingsBasicActivity extends PreferenceActivity {
    ...
    protected void onStart() {
        ...
        dimensions.put("Name", "SettingsBasicActivity");
        ParseAnalytics.trackEventInBackground("OpenScreen", dimensions);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ManagerService.getInstance(this).registerUser();
    ...
    public void onBuildHeaders(List<Header> target) {
        if (!isSimplePreferences(this)) {
            loadHeadersFromResource(R.xml.pref_headers_basic, target);
        }
    }
